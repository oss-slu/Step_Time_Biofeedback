...
async def test_string_websocket():
    ...
    with client.websocket_connect("/ws") as websocket:
        ...
        assert data == "Message Received: Hello from the backend"
...
def test_number_websocket():
    ...
    with client.websocket_connect("/ws") as websocket:
        ...
        data = websocket.receive_text()
        assert data == "Message Received: 123123"
...
def test_float_websocket():
    ...
    with client.websocket_connect("/ws") as websocket:
        ...
        data = websocket.receive_text()
        assert data == "Message Received: 123.123"
...
def test_boolean_websocket():
    ...
    with client.websocket_connect("/ws") as websocket:
        ...
        data = websocket.receive_text()
        assert data == "Message Received: True"
...
def test_error_websocket():
    ...
    with client.websocket_connect("/ws") as websocket:
        ...
        data = websocket.receive_text()
        assert data != "Message Received: This is the message"
...
def test_array_websocket():
    ...
    with client.websocket_connect("/ws") as websocket:
        ...
        data = websocket.receive_text()
        assert data == "Message Received: [1, 2, 3, 4, 5]"
